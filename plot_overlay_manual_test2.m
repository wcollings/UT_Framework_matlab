...
handling_args = {11};
data = handling_transient('Test2.csv', handling_args);
t_emp = data{2,1};
vds_emp = data{2,2};
vgs_emp = data{2,3};
id_emp = data{2,4};
...
figure
title('Test 2: Static Model Turn-off')
yyaxis left
hold on
...
figure
title('Test 2: Dynamic Model Turn-off')
yyaxis left
hold on
plot(t_vds_off, vds_emp, 'linestyle', '-', 'color', color_v_emp, 'linewidth', lw)
...
figure
title('Test 2: Static Model Turn-on')
yyaxis left
hold on
...
figure
title('Test 2: Dynamic Model Turn-on')
yyaxis left
hold on
plot(t_vds_on, vds_emp, 'linestyle', '-', 'color', color_v_emp, 'linewidth', lw)

...
% Note: This code is updated from its original form to accomodate LTspice XVII files. The details are included in the readme.txt file
%
% LTSPICE2MATLAB -- Reads an LTspice XVII .RAW waveform file containing data from a Transient Analysis (.tran) or

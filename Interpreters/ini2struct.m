...
% 
% If INI file contains "orphan" variables at the beginning, they will be
...
res = strtrim(s);               % Remove leading and trailing whitespace
if strcmpi(res(1),'=')          % If the first character is '=' 
    res(1)=[];                  %   remove the first character
end
res = strtrim(res);             % Remove leading and trailing whitespace
return;